...
$array = querySQL("SELECT * FROM tab_trabajos WHERE id_trabajos = $id");
...
<div class="row">
  <div class="col-md-12 grid-margin">
    <div class="d-flex justify-content-between align-items-center">
      <div>
        <h4 class="font-weight-bold mb-0"><i class="ti-briefcase pr-2"></i> Trabajos > <?php echo $array['titulo'];?></h4>
      </div>
      <div>
...
<div class="row">
  ...
  <div class="col-md-8 grid-margin">
    ...
    <div class="card">
      ...
      if($tapa == 'Y'){ ?>
        <a href="javascript:cargar('_edit','id=<?php echo $array['id_trabajos'];?>&tapa=N');" style="position:absolute; background:rgba(255, 255, 255, 0.3); border:none; width:100%; height:100%; z-index:1000; padding: 0;" class="text-center btn btn-primary"></a>
      <?php } 
      //fin tapa 
      ?>
      <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control" name="categ">
                    ...
                    ?>
                    <option value="<?php echo $arrayP['id_categ'];?>" <?php if($array['categ'] == $arrayP['id_categ']) echo 'selected="selected"'; ?>><?php echo ($arrayP['nombre']);?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
  ...
  <div class="col-md-4 grid-margin">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <a href="#" class="btn btn-danger btn-sm" onclick="eliminar('_delete','<?php echo $id;?>');"><i class="ti-trash icon-tiny"></i> Eliminar Trabajo</a>
      </div>
    </div>
  </div>
