...
<div class="row">
    ...
    ?>
        ...
        <div class="col-md-6 col-xs-6 grid-margin text-center pb-3" style="border-bottom: #e7e7e7 1px solid;">
        ...
        <br>
        <p class="small" style="height: 18px;"><?php echo substr($array['name'],0,30); ?></p>
        <br>
        <div id="resultFiles"></div>
        <?php if(empty($ver)){ ?>
            <a href="javascript:deleteFilesRelation('resultFiles','<?php echo $idFilesRelation; ?>','<?php echo $page;?>','<?php echo $idArticulo;?>')" 
            class="btn btn-danger btn-xs small" style="border-bottom: #e7e7e7 1px solid;">Quitar</a>
        <?php } ?>
        </div>
